...
\title{A computational approach for understanding and predicting user behavior}
...
Our study in this research is based on six features. These features cover the four core areas of the CCS which are: (1) Digital library resources, (2)Publisher material, (3)Community contributed resources (4)Personalization
...
\end{tabular}
\end{table}
From \ref{cluster1month}, it is clear that the number of sessions, hours and my stuff activity varies remain constantly high across all months. This indicates that a value of high in these three features is a strong predictor of membership within this cluster.  The values of interactive resource activity, my Stuff activity and shared stuff Activity vary quite a bit within the school year.
...
We ran the Apriori algorithm on the set of all transactions of all users in the power user type and the ten strong rules (rules meeting the minimum support of 0.5 and minimum confidence of 0.9 thresholds) were generated. They are as follows:
 ...
 $1. Number_of_sessions=high Hours_spent=high 28 ==> Publisher_activity=high 27    conf:(0.96)
 2. Publisher_activity=high 31 ==> Number_of_sessions=high 29    conf:(0.94)
 3. Number_of_sessions=high 31 ==> Publisher_activity=high 29    conf:(0.94)
 4. Publisher_activity=high 31 ==> Hours_spent=high 29    conf:(0.94)
 5. Hours_spent=high Publisher_activity=high 29 ==> Number_of_sessions=high 27    conf:(0.93)
 6. Number_of_sessions=high Publisher_activity=high 29 ==> Hours_spent=high 27    conf:(0.93)
 7. Number_of_sessions=high 31 ==> Hours_spent=high 28    conf:(0.9)$
...
$Hours_spent=low Publisher_activity=mid Shared_stuff_activity=low 27 ==> Interactive_Resource_Act=low 25    conf:(0.93)$
...
$ 1. Hours_spent=low Shared_stuff_activity=low 27 ==> My_Stuff_Activity=low 26    conf:(0.96)
 2. Publisher_activity=low Shared_stuff_activity=low 27 ==> My_Stuff_Activity=low 26    conf:(0.96)
 3. Interactive_Resource_Act=low Shared_stuff_activity=low 34 ==> My_Stuff_Activity=low 31    conf:(0.91)$
